...
class PredictionRPSScorerTest {
    private val rps = PredictionRPSScorer()
    ...
    private companion object {
        ...
        fun gameArguments(): Stream<Arguments> = Stream.of(
            Arguments.of(listOf("A X"), 3), // Rock beats scissors
            Arguments.of(listOf("B X"), 1), // Paper beats rock
            Arguments.of(listOf("B Z"), 9), // Scissors beat paper
            Arguments.of(listOf("C X"), 2), // Player loses
            Arguments.of(listOf("A Y"), 4), // Player ties
            Arguments.of(listOf("A Z"), 8), // Player wins
        )
    }
    ...
    fun multipleGames() {
        ...
        assertEquals(11, rps.calculateScore(games))
    }

    @Test
    fun acceptanceTest() {
        val games = listOf("A Y", "B X", "C Z")
        assertEquals(12, rps.calculateScore(games))
    }
    ...
    fun puzzleTwo() {
        ...
        assertEquals(11657, rps.calculateScore(games))
    }
}
