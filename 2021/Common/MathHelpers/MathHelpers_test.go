...
func TestAbsValuePositive(t *testing.T) {
	a.AssertEqual(AbsoluteValue(5), 5, t)
}

func TestAbsValueNegative(t *testing.T) {
	a.AssertEqual(AbsoluteValue(-12), 12, t)
}

func TestCalculateMin(t *testing.T) {
	a.AssertEqual(CalculateMin(3, 6), 3, t)
	a.AssertEqual(CalculateMin(-5, 0), -5, t)
	a.AssertEqual(CalculateMin(5, 5), 5, t)
}

func TestFindMaxValue(t *testing.T) {
	slice := []int{21, 34, 243, 223, -1}
	a.AssertEqual(FindMaxValue(slice), 243, t)
}

func TestConvertStringToInt(t *testing.T) {
	a.AssertEqual(ConvertStringToInt("4"), 4, t)
	a.AssertEqual(ConvertStringToInt("485"), 485, t)
	a.AssertEqual(ConvertStringToInt("-22"), -22, t)
	a.AssertEqual(ConvertStringToInt("0"), 0, t)
}
...
func TestPermutationAcceptance(t *testing.T) {
	a.AssertEqual(len(CalculatePermutations([]int{1, 2, 3, 4, 5, 6, 7})), 5040, t)
}
